...
3.  Вызовите метод [Build](xref:Android.App.Notification.Builder.Build) сборки объекта `NotificationCompat.Builder`, чтобы создать экземпляр объекта уведомления.
