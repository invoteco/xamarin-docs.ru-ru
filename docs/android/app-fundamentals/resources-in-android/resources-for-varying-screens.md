...
- **Выберите одну ориентацию макета в качестве &ndash; по умолчанию** , например, вместо предоставления альтернативных ресурсов **Layout-Land** и **Layout-Port**, разместите ресурсы для альбомнойориентации и ресурсы для книжной ориентации на **Layout — порт**.
