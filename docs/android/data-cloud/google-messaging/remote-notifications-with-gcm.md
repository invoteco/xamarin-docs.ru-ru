...
Теперь мы готовы протестировать наше приложение клиента. Если вы используете эмулятор или устройство обменивается с GCM Wi-Fi, необходимо открыть следующие TCP-порты в брандмауэре сообщений GCM, позволяющих протащить: 5228 5229 и 5230: создание.
