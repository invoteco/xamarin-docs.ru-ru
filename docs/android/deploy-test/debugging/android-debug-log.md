...
- **Селектор устройств** — выбор физического устройства или запущенного эмулятора для мониторинга.

- **Записи журнала** — таблица сообщений из журнала logcat.
...
- **Отображение сообщений** — включение и отключение отображения информационных сообщений.

- **Отображение предупреждений** — включение и отключение отображения сообщений с предупреждениями (выделены желтым цветом).

- **Отображение ошибок** — включение и отключение отображения сообщений об ошибках (выделены красным цветом).

- **Повторное подключение** — переподключение к устройству и обновление отображаемых записей журнала.

- **Добавление маркера** — вставка сообщения маркера (например, `--- Marker N ---`) после последней записи журнала, где _N_ — это счетчик, который начинается с 1 и увеличивается на 1 по мере добавления новых маркеров.
