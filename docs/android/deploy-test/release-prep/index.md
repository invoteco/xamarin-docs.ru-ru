...
- **[Защита приложения](#protect_app)**  — запретите пользователям или злоумышленникам выполнять отладку, незаконное изменение, или реконструирование приложения, отключив отладку, маскируя управляемый код, добавляя возможности защиты от отладки и незаконного изменения, а также используя компиляцию в машинный код.
