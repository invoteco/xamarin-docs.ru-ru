...
- **[Настройка свойств упаковки](#Set_Packaging_Properties)**  — свойства упаковки определяют, как будет создаваться пакет приложения для Android (APK). Этот шаг позволяет оптимизировать пакет APK, защитить его ресурс и при необходимости разбить его на модули.
