...
- Если вы используете Visual Studio 15.8, предварительная версия 5, или более позднюю версию, вы можете использовать [дистрибутив OpenJDK для мобильных устройств от Майкрософт](openjdk.md) вместо JDK 8.
...
### <a name="repository-selection"></a>Выбор репозитория
...
- Если вы используете Visual Studio, для Mac 7.7, или более позднюю версию, вы можете использовать [дистрибутив OpenJDK для мобильных устройств от Майкрософт](openjdk.md) вместо JDK 8.
