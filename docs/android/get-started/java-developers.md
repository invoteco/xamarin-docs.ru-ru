...
- [Свойства](#properties) &ndash; С помощью системы свойств C# можно напрямую и безопасно получить доступ к переменным-элементам без необходимости писать методы задания и получения.
