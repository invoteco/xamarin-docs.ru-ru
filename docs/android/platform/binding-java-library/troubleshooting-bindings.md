...
- инструкции для библиотек &ndash; без ссылок указывают на библиотеку, на которую нет ссылок, и добавляют эти зависимости в проект привязки Xamarin. Android с **действием сборки** референцежар или **`import`**  **Ембедддедреференцежар**.
