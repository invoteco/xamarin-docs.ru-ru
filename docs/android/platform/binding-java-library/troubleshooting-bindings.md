...
### <a name="problem-generated-c-source-does-not-build-due-to-parameter-type-mismatch"></a>Проблема: Созданный C# источника не выполняет сборку из-за несоответствия типа параметра
...
### <a name="problem-name-collisions-on-inner-classes--properties"></a>Проблема: Назовите конфликтов на внутренние классы и свойства
...
### <a name="problem-a-so-library-required-by-the-binding-is-not-loading"></a>Проблема: Объект **.so** — библиотеки, необходимые в привязке не удалось загрузить
