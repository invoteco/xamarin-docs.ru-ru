...
Можно также использовать более ранние версии Android `CursorLoader` , используя [библиотек поддержки v4](https://developer.android.com/tools/support-library/index.html).
