...
- [Android 4.1 API-интерфейсов](https://developer.android.com/about/versions/android-4.1.html)
- [Задачи и стеки назад](https://developer.android.com/guide/components/tasks-and-back-stack.html)
- [Переход с помощью назад» и «вверх](https://developer.android.com/design/patterns/navigation.html)
