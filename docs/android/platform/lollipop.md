...
- **Быстроистекает\_скорость медленного\_ускорения и медленно замедляется в сторону конца анимации.\_** &ndash;

- **\_Линейное\_выходное значение\_медленное в** &ndash; начинается с пиковой скорости и медленно замедляется до конца анимации.
