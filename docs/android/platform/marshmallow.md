...
Xamarin также предоставляет пример приложения, которое показывает, как работают разрешения среды выполнения в Android Marshmallow (и более поздних версиях): [Рунтимепермиссионс](https://developer.xamarin.com/samples/monodroid/android-m/RuntimePermissions).
...
Xamarin предоставляет пример приложения, демонстрирующий использование зарегистрированных отпечатков пальцев для проверки подлинности пользователя в приложении: [Финжерпринтдиалог](https://developer.xamarin.com/samples/monodroid/android-m/FingerprintDialog).
...
Xamarin предоставляет пример приложения, демонстрирующий использование учетных данных устройства (например, ПИН-кода, шаблона или пароля) в приложении. [конфирмкредентиал](https://developer.xamarin.com/samples/monodroid/android-m/ConfirmCredential/)
...
Xamarin предоставляет пример приложения, которое демонстрирует новую библиотеку разработки Android на Xamarin. Android &ndash; [чисескуаре](https://developer.xamarin.com/samples/monodroid/android5.0/Cheesesquare).
...
- [Рунтимепермиссионс (пример)](https://developer.xamarin.com/samples/monodroid/android-m/RuntimePermissions)
- [Конфирмкредентиал (пример)](https://developer.xamarin.com/samples/monodroid/android-m/ConfirmCredential)
- [Финжерпринтдиалог (пример)](https://developer.xamarin.com/samples/monodroid/android-m/FingerprintDialog)
