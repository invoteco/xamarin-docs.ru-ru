...
Дополнительные сведения о Android 7.x API-интерфейсов, см. в разделе [Android 7.1 для разработчиков](https://developer.android.com/preview/api-overview.html).
