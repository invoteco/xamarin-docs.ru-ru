...
- **Visual Studio** &ndash; рекомендуется 2019 г. Visual Studio.
    Если вы используете Visual Studio 2017, в центре обновления Windows для Visual Studio 2017 версии 15,8 или более поздней версии. В Mac OS обновление до Visual Studio 2017 для Mac версии равен 7,6 или более поздней версии.
...
2019 г. Visual Studio рекомендуется для создания приложений Android круговой, с помощью Xamarin.

Если вы используете Visual Studio 2017, обновление до Visual Studio 2017 версии 15,8 или более поздней версии (инструкции см. в разделе [обновление Visual Studio 2017 до последней версии](https://docs.microsoft.com/visualstudio/install/update-visual-studio)). В Mac OS, обновление до Visual Studio 2017 для Mac 7.6 или более поздней версии (инструкции см. в разделе [Установка и настройка Visual Studio для Mac](https://docs.microsoft.com/visualstudio/mac/installation)).
...
2. В правом нижнем углу щелкните значок шестеренки и выберите **репозитория > Google (не поддерживается)**:
    ...
    [![Sвыполнение репозитория для Google](pie-images/vs/set-repo-sml.png)](pie-images/vs/set-repo.png#lightbox)
...
3. Установка **Android круговой** пакетов SDK, которые указаны в виде **Android SDK платформы 28** в **платформ** вкладке (Дополнительные сведения об использовании диспетчера пакетов SDK см. в разделе [ Программа установки Android SDK](~/android/get-started/installation/android-sdk.md)):
    ...
    [![Iпакеты Android круговой nstalling](pie-images/vs/sdk-manager-sml.png)](pie-images/vs/sdk-manager.png#lightbox)
...
[![AЭмулятор ndroid, имитируя обрезки](pie-images/02-example-cutout-sml.png)](pie-images/02-example-cutout.png#lightbox)
...
[![Example обрезки режимы отображения в эмуляторе](pie-images/03-cutout-modes-sml.png)](pie-images/03-cutout-modes.png#lightbox)
...
[![Example уведомлений с изображениями](pie-images/04-example-notifications-sml.png)](pie-images/04-example-notifications.png#lightbox)
...
[![Example внутри помещений навигацию, с помощью Wi-Fi времени приема-Передачи](pie-images/05-wifi-rtt-sml.png)](pie-images/05-wifi-rtt.png#lightbox)
