...
## <a name="installfailedinvalidapk-when-installing-a-package"></a>При\_установке\_пакета\_не удалось установить недопустимый apk
...
## <a name="installfailedmissingsharedlibrary-when-installing-a-package"></a>При\_установке\_пакета\_не удалось удалить общую библиотеку\_
...
## <a name="installfailedupdateincompatible-when-installing-a-package"></a>Не\_удалось\_установитьОбновление\_, несовместимое с установкой пакета
...
## <a name="installfaileduidchanged-when-installing-a-package"></a>При установке\_пакета\_изменилсянеудачныйUID\_
