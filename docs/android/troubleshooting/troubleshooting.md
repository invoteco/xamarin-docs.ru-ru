...
Xamarin.Android использует системные свойства Android для управления созданием дополнительных сообщений в журнал отладки Android. Системные свойства Android можно задать с помощью *setprop* команду в пределах [Android Debug Bridge (adb)](https://developer.android.com/guide/developing/tools/adb.html):
