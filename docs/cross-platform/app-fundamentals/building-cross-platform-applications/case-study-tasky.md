...
Приложение Android использует встроенные элементы управления, включая встроенный макет для строк, требующих отображения "Tick". В дополнение к экранной кнопке «Back» поддерживается поведение оборудования и системы обратно.
 ...
 [![](case-study-tasky-images/android-taskylist.png "В дополнение к экранной кнопке")](case-study-tasky-images/android-taskylist.png#lightbox)обратной передачи, поддерживаемой аппаратным и системным нажатием[![], в дополнение к экранной кнопке «Back»(case-study-tasky-images/android-taskylist.png "поддерживается поведение оборудования и системы") .](case-study-tasky-images/android-taskylist.png#lightbox)
