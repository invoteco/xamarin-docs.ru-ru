...
Разработки приложений Android требуется Java и пакеты SDK для Android для установки. Они предоставляют компилятора, эмулятора и другие средства, необходимые для создания, развертывания и тестирования. Java, Google пакета SDK для Android и Xamarin средств можно все устанавливаться и работать в Windows и macOS. Рекомендуется использовать следующие конфигурации:

- Windows 10 с Visual Studio 2019 г.
- macOS Mojave (10.11 или более поздней) с 2019 г. Visual Studio для Mac
