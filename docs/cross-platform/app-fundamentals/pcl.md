...
[![список 14 классов в классе System.IO для PCL](pcl-images/image6.png)](pcl-images/image6.png#lightbox)
...
[![списка IntelliSense классов 40 в пространстве имен .NET Framework System.IO](pcl-images/image7.png)](pcl-images/image7.png#lightbox)
...
[![добавить ссылку на PCL с помощью параметра Edit References](pcl-images/image8.png)](pcl-images/image8.png#lightbox)
...
[![пример решения Таскипортабле, показывающего проект PCL](pcl-images/image9.png)](pcl-images/image9.png#lightbox)
...
[![ограниченного числа классов ввода-вывода, доступных в PCL](pcl-images/image14.png)](pcl-images/image14.png#lightbox)
...
[![многих других классов ввода-вывода, доступных в .NET Framework](pcl-images/image15.png)](pcl-images/image15.png#lightbox)
...
[![добавить ссылку на PCL с помощью вкладки "добавить ссылочные проекты"](pcl-images/image16.png)](pcl-images/image16.png#lightbox)
