...
[![](pcl-images/image1.png "На этой схеме показана архитектура межплатформенного приложения с использованием переносимой библиотеки классов для совместного использования кода, но также использование внедрения зависимостей для передачи функций, зависящих от платформы")](pcl-images/image1.png#lightbox)
...
[![Параметры проекта PCL для задания профиля](pcl-images/image4-sml.png)](pcl-images/image4.png#lightbox)
...
[![Список IntelliSense 14 классов в классе System.IO для PCL](pcl-images/image6.png)](pcl-images/image6.png#lightbox)

Сравните это с автозавершением System.IO в проекте Xamarin. iOS или Xamarin. Android — доступно 40 классов, включая часто используемые классы, такие как `File` и `Directory` , которые не находятся ни в одном профиле PCL.

[![Список IntelliSense классов 40 в пространстве имен System.IO .NET Framework](pcl-images/image7.png)](pcl-images/image7.png#lightbox)
...
[![Добавление ссылки на PCL с помощью параметра "изменить ссылки"](pcl-images/image8.png)](pcl-images/image8.png#lightbox)
...
[![Образец решения Таскипортабле, демонстрирующий проект PCL](pcl-images/image9.png)](pcl-images/image9.png#lightbox)
...
[![Изменение целевых платформ](pcl-images/image13-sml.png)](pcl-images/image13.png#lightbox)
...
[![Сокращенное число классов ввода-вывода, доступных в PCL](pcl-images/image14.png)](pcl-images/image14.png#lightbox)
...
[![Многие другие классы ввода-вывода доступны в .NET Framework](pcl-images/image15.png)](pcl-images/image15.png#lightbox)
...
После создания проекта PCL можно добавить ссылку на него из любого совместимого приложения или проекта библиотеки так же, как обычно добавляются ссылки. В Visual Studio щелкните правой кнопкой мыши узел ссылки и выберите пункт `Add Reference...` перейти на вкладку **решение > проектов** , как показано ниже.

[![Добавление ссылки на PCL с помощью вкладки "добавить ссылочные проекты"](pcl-images/image16.png)](pcl-images/image16.png#lightbox)
...
[![Пример решения Таскипортабле с библиотекой PCL](pcl-images/image17.png)](pcl-images/image17.png#lightbox)
...
[![](pcl-images/image18.png "Ниже приведены некоторые снимки экрана приложений, работающих в iOS, Android и Windows Phone")](pcl-images/image18.png#lightbox)
...
[![](pcl-images/image19.png "Структура решения показана здесь в Visual Studio для Mac и Visual Studio соответственно")](pcl-images/image19.png#lightbox)
