---
title: Жизненный цикл разработки мобильного ПО
...
## <a name="mobile-development-software-lifecycle"></a>Жизненный цикл мобильного ПО для разработки
...
Чтобы упростить проектирование функций приложения, рекомендуется определить субъекты и [варианты использования](https://en.wikipedia.org/wiki/Use_case). Субъекты — это роли в рамках приложения, которые часто соответствуют его пользователям. Варианты использования — это типовые действия или цели.
...
1. [Amazon App Store для Android](https://www.amazon.com/mobile-apps/b?ie=UTF8&amp;node=2350149011)
...
#### <a name="device-and-operating-system-fragmentation"></a>Фрагментация устройств и операционных систем
...
- [Что такое Xamarin?](~/cross-platform/get-started/introduction-to-mobile-development.md)
- [Начало работы с Xamarin](~/get-started/index.yml)
- [Совместное использование кода несколькими платформами](~/cross-platform/app-fundamentals/index.md)
