...
По состоянию на 31 июля мы опубликовали порты образцов iOS для этого нового API на `magic-types` ветви в [односенсорных примерах](https://github.com/xamarin/monotouch-samples/commits/magic-types).
