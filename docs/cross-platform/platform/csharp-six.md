...
description: Версия 6 C# языка постоянно развивается язык меньше стандартного кода, внесена большая ясность и согласованность. Более четкий синтаксис инициализации, возможность использовать выражение await в блоках catch/finally и условием null? оператор, особенно полезны.
ms.prod: xamarin
...
ms.locfileid: "67850946"
---
# <a name="c-6-new-features-overview"></a>C#Обзор новых возможностей 6

_Версия 6 C# языка постоянно развивается язык меньше стандартного кода, внесена большая ясность и согласованность. Более четкий синтаксис инициализации, возможность использовать выражение await в блоках catch/finally и условием null? оператор, особенно полезны._

> [!NOTE]
> Сведения о последней версии C# язык — версии 7 — ознакомьтесь со статьей [новые возможности в C# 7.0](/dotnet/csharp/whats-new/csharp-7)
