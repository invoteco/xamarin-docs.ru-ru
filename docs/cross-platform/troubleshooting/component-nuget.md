...
3. Найдите в файле `XamarinComponentReference`все ссылки на. Он должен выглядеть следующим образом:
...
2. Найдите в файле `XamarinComponentReference`все ссылки на. Он должен выглядеть следующим образом:
