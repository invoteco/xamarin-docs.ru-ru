...
Xamarin можно удалить из 2019 г. Visual Studio и Visual Studio 2017, с помощью приложения установщика:

1. Откройте **установщик Visual Studio** из меню **Пуск**.

2. Нажмите кнопку **Изменить**, предварительно выбрав изменяемый экземпляр.

    [![](uninstalling-xamarin-images/vs2017-02-sml.png "Нажмите кнопку \"Изменить\"")](uninstalling-xamarin-images/vs2017-02.png#lightbox)
...
3. На вкладке **Рабочие нагрузки** отмените выбор параметра **Разработка мобильных приложений на платформе .NET** (в разделе **Мобильные приложения и игры**).
    ...
    [![](uninstalling-xamarin-images/vs2017-03-sml.png "Снимите флажок рабочая нагрузка разработки мобильных приложений")](uninstalling-xamarin-images/vs2017-03.png#lightbox)
...
5. Установщик удалит компоненты, выбор которых отменен (прежде чем установщик сможет вносить изменения, необходимо закрыть Visual Studio 2017).
    ...
    [![](uninstalling-xamarin-images/vs2017-04-sml.png "Нажмите кнопку \"Изменить\"")](uninstalling-xamarin-images/vs2017-04.png#lightbox)
...
[![](uninstalling-xamarin-images/vs2017-uninstall-sml.png "Полностью удалить Visual Studio")](uninstalling-xamarin-images/vs2017-uninstall.png#lightbox)
...
Xamarin можно удалить с компьютера Windows через **панель управления**. Перейдите к элементу **Программы и компоненты** или **Программы > Удаление программы**, как показано ниже:
 ...
 [![](uninstalling-xamarin-images/image3.png "Перейдите к программы \"и\" функции \"или\" Удаление программы программы, как показано ниже")](uninstalling-xamarin-images/image3.png#lightbox) 
...
Первый шаг в удалении Xamarin Studio из Mac заключается в поиске файла **Xamarin Studio.app** в каталоге **/Applications** и перетаскивании его в **корзину**. Можно также щелкнуть правой кнопкой мыши и выбрать пункт **Переместить в удаленные**, как показано ниже:
 ...
 [![](uninstalling-xamarin-images/image1.png "Кроме того щелкните правой кнопкой мыши и выберите Переместить в корзину, как показано ниже")](uninstalling-xamarin-images/image1.png#lightbox)
