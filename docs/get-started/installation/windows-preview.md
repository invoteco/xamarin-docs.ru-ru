...
[![eпсевдоним информационного дерева каталога перед установкой](windows-images/vs2017-nickname-sml.png "Изменение псевдонима перед установкой")](windows-images/vs2017-nickname.png#lightbox)
