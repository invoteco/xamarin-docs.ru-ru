...
## <a name="create-a-single-page-xamarinforms-applicationsingle-pagemd"></a>[Создание одной страницы приложения Xamarin. Forms](single-page.md)
...
## <a name="perform-navigation-in-a-multi-page-xamarinforms-applicationmulti-pagemd"></a>[Выполнение навигации в приложении Xamarin. Forms с несколькими страницами](multi-page.md)
...
## <a name="style-a-cross-platform-xamarinforms-applicationstylingmd"></a>[Стиль для кросс-платформенного приложения Xamarin. Forms](styling.md)

Узнайте, как изменить стиль кроссплатформенного приложения Xamarin.Forms с помощью стилей XAML.

## <a name="quickstart-deep-divedeepdivemd"></a>[Краткое руководство по началу работы](deepdive.md)
