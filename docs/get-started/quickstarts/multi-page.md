...
[![Скачать пример](~/media/shared/download.png) Скачать пример](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/getstarted-notes-multipage/)
...
Страница «заметки» [ ![(multi-page-images/screenshots1-sml.png " ")]] (multi-page-images/screenshots1.png#lightbox "Страница «заметки»") Страница ввода примечания страница(multi-page-images/screenshots2.png#lightbox "записи примечания") [ ![(multi-page-images/screenshots2-sml.png " ")]] 
...
7. В **Обозреватель решений**щелкните правой кнопкой мыши проект **Notes** и выберите **Добавить > новый элемент..** . В диалоговом окне **Добавление нового элемента** выберите **визуальные C# элементы > странице Xamarin. Forms > Content**, назовите новый файл **нотинтрипаже**и нажмите кнопку **Добавить** :
...
10. В **Обозреватель решений**щелкните правой кнопкой мыши проект **Notes** и выберите **Добавить > новый элемент..** . В диалоговом окне **Добавление нового элемента** выберите **визуальные C# элементы > странице Xamarin. Forms > Content**, назовите новый файл **нотеспаже**и нажмите кнопку **Добавить** .
