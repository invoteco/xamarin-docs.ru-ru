...
![](part2-images/image1.png "При появлении запроса о том, как добавить файл в папку, выберите параметр копирования.")

Папка Content теперь содержит файл чарактершит. PNG:

![](part2-images/image2.png "Папка Content теперь содержит файл чарактершит. png")
...
![](part2-images/image3.png "Запуск игры теперь показывает один спрайт, отображающий текстуру, созданную из чарактершит. png")
...
![](part2-images/image4.png "Поскольку X и Y по умолчанию имеют значение 0, то символ располагается в левом верхнем углу экрана.")
...
![](part2-images/image5.gif "Теперь Чарактерентити будет играть свою Валкдовную анимацию")
...
![](part2-images/image6.gif "Символ перемещается к сенсорному месту")
...
![](part2-images/image7.gif "Результатом этого кода является то, что символ будет правильно анимироваться при прохождении, а затем в последнем направлении, когда он был остановлен")
