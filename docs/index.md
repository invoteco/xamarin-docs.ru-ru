...
featureFlags:
- clicktale
ms.openlocfilehash: d3c73ef7e657641618741f4276f2168f2b76b372
ms.sourcegitcommit: 6264fb540ca1f131328707e295e7259cb10f95fb
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/16/2019
ms.locfileid: "69521685"
---
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Установка и настройка</h3>
                                    <p>Сведения об установке Инструментов Visual Studio для Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Новые возможности</h3>
                                    <p>Узнайте об обновлениях в документации по Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="~/cross-platform/get-started/introduction-to-mobile-development.md"><img  src="https://docs.microsoft.com/media/logos/logo_xamarin.svg" alt="" />Что такое Xamarin?</a></li>
                                                    ...
                                                    <li><a class="barLink" href="~/xamarin-forms/data-cloud/index.yml"><img  src="https://docs.microsoft.com/media/logos/logo_azure.svg" alt="" />Azure с Xamarin</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4>Следуйте этим инструкциям, чтобы создать свое первое кроссплатформенное приложение для Android и iOS с Xamarin.Forms за 5 минут.</h4>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Учебники</h3>
                                                <h4>Сведения о кроссплатформенных концепциях приложений для Android и iOS, созданных с Xamarin.Forms.</h4>
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Используйте имеющиеся знания</h3>
                                                <h4>Проекты Xamarin позволяют использовать уже имеющиеся у вас навыки для создания приложений Android и iOS. Выберите свою платформу для получения дополнительных сведений:</h4>
                        ...
                        <ul id="XamarinForms" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>
Xamarin.Forms — это кроссплатформенный набор средств для Android, iOS, Mac и Windows, использующий C# и .NET. Создавайте код пользовательского интерфейса и программной логики, общий для всех платформ.
                                    </p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Что такое Xamarin.Forms?</h3>
                                                    <p>Узнайте, что представляет собой набор Xamarin.Forms и как с его помощью создавать и развертывать приложения для Android и iOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Все, что необходимо знать для разработки приложений Xamarin.Forms, например, навигация, жесты, привязка данных и многое другое.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Дополнительные сведения об элементах управления пользовательским интерфейсом на поддерживаемых платформах.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Кроссплатформенные API-интерфейсы для стандартных задач приложения.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Данные и облачные службы Azure</h3>
                                                    <p>Хранение данных и доступ к облачным службам Azure.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Дополнительные сведения о разработке .NET на macOS с помощью Visual Studio для Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Симулятор iOS для Windows</h3>
    ...
    <div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
                <a href="https://devblogs.microsoft.com/xamarin/"> Блог </a>
            </li>
            <li>
