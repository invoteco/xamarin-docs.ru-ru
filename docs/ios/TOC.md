...
## Платформа Apple
### [Обзор iOS и macOS](~/cross-platform/macios/index.md?context=xamarin/ios)
...
### [Предварительная версия Xcode 11](~/ios/platform/ios13/troubleshooting/index.md)
