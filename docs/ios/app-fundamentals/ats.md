...
> Безопасность транспорта приложений заблокировала открытый текст HTTP (http://www.-the-blocked-domain.com) загрузку ресурсов, так как она небезопасна. Временные исключения можно настроить с помощью файла INFO. plist приложения.
