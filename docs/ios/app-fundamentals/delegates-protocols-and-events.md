...
[![](delegates-protocols-and-events-images/01-map-sml.png "Пример простого приложения для карт, добавляющего заметку к сопоставлению")](delegates-protocols-and-events-images/01-map.png#lightbox)
[![].(delegates-protocols-and-events-images/04-annotation-with-callout-sml.png "Пример заметки, добавленный на карту")](delegates-protocols-and-events-images/04-annotation-with-callout.png#lightbox)
