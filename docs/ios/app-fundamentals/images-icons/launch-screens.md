...
5. Добавьте образ в каталог активов в проекте, чтобы он был доступен для использования на экране запуска:
    ...
    - Добавьте новый набор изображений в каталог активов **активов** , как описано в разделе [Добавление изображений в набор изображений каталога активов](~/ios/app-fundamentals/images-icons/displaying-an-image.md) в области [отображения](~/ios/app-fundamentals/images-icons/displaying-an-image.md) руководств по изображениям.
...
Дополнительные сведения о создании экрана запуска с помощью унифицированной раскадровки см. в разделе « [экраны динамического запуска](~/ios/user-interface/storyboards/unified-storyboards.md#dynamic-launch-screens) » раздела « [унифицированные](~/ios/user-interface/storyboards/unified-storyboards.md) раскадровки».
