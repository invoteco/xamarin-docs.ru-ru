...
Элементы управления в `UIKit` — эти подклассы из Уиконтрол — поэтому зависят от взаимодействия с пользователем о том, что у них есть встроенные жесты в UIKit и поэтому нет необходимости в включении сенсорного ввода. Он уже включен.
