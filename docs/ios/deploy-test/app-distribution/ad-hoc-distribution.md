...
2. Далее щелкните **знак "плюс" (+)** и выберите пункт **iOS App Store**:  [![](ad-hoc-distribution-images/selectcert.png "Выбор пункта iOS App Store")](ad-hoc-distribution-images/selectcert.png#lightbox)
