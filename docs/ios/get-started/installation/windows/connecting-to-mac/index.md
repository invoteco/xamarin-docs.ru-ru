...
Функция "Связать с Mac" выполняет установку или обновление необходимого программного обеспечения, когда Visual Studio 2017 [подключается к компьютеру Mac](#connect-to-the-mac-from-visual-studio-2019).
