...
2. Установите флажок **Remote Login** (Удаленный вход) в списке **Service** (Служба).
    ...
    ![Включение удаленного входа](images/sharing.png "Включение удаленного входа")
...
1. Найдите IP-адрес нужного компьютера Mac.
    ...
    - На компьютере Mac откройте **System Preferences (Системные настройки) > Sharing (Общий доступ) > Remote Login (Удаленный вход)** :
      ...
      [![IP-адрес Mac в разделе "System Preferences" (Системные настройки) > "Sharing" (Общий доступ)](images/sharing-ipaddress.png "IP-адрес Mac в разделе System Preferences (Системные настройки) > Sharing (Общий доступ)")](images/sharing.png#lightbox)
...
Функция "Связать с Mac" выполняет установку или обновление необходимого программного обеспечения, когда Visual Studio 2019 [подключается к компьютеру Mac](#connect-to-the-mac-from-visual-studio-2019).
...
> [!NOTE]
> Visual Studio 2019 хранит `msbuild` в следующем каталоге. **C:\Program Files (x86)\Microsoft Visual Studio\2019\\&lt;версия&gt;\MSBuild\Current\Bin**
