...
> 
> - На компьютере Windows [установите Visual Studio 2017](~/get-started/installation/windows.md).
...
> [!NOTE]
> Visual Studio 2017 хранит `msbuild` в следующем каталоге: **C:\Program Files (x86)\Microsoft Visual Studio\2017\\&lt;Version&gt;\MSBuild\15.0\Bin**
