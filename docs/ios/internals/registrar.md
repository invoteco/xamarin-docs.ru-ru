...
- Необходимо обновить некоторые сторонние библиотеки для работы с новой системой регистрации. См. в разделе [необходимые изменения](#required-modifications) ниже для получения дополнительных сведений.
