...
Иногда пользователям нужно ссылаться на один и тот же класс из нескольких **XIB** файлов, например с помощью контроллеров вкладок. Это можно сделать, неявно ссылку на определение класса из другого **xibного** файла или определив еще одно имя класса во втором **. XIB**.
