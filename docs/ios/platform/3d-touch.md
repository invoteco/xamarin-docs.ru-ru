...
- [Чувствительность](#Pressure-Sensitivity) к нажиму. приложения теперь могут измерять, насколько жестко или светлое пользователь касается экрана, и пользоваться этими сведениями.
