...
Обратите внимание на то, как подобный процесс является обычным процессом написания приложения. `UIViewController` расширения имеет тот же жизненный цикл, что и контроллер представления в приложении, за исключением того, что расширения не имеют фоновых режимов и не приостанавливаются после того, как пользователь завершит их использование. Вместо этого расширения многократно инициализируются и освобождаются при необходимости.
