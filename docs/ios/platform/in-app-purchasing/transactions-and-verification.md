...
Примечание. Реальные приложения следует внедрять безопасный механизм для хранения, приобретенных содержимое, которое не является уязвимы для несанкционированного доступа пользователя. Для этого может потребоваться шифрование и/или других методов, включая идентификацию удаленным сервером.   
