...
- [NSPersistentStoreCoordinator](xref:CoreData.NSPersistentStoreCoordinator) символы, связанные с повсеместно содержимое стали нерекомендуемыми.
