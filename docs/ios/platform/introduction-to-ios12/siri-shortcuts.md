...
Установка свойства подает _действию значение Siri._ `UserActivity` В этом пожертвовании Siri получает информацию о том, когда и где это действие имеет отношение к пользователю, и узнает, как лучше предлагать его в будущем.
