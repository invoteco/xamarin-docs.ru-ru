...
- [StoreKit (пример)](https://developer.xamarin.com/samples/monotouch/StoreKit/)
...
- [WWDC видео. Наиболее популярных продуктов с помощью комплекта Store](https://developer.apple.com/videos/wwdc/2012/?include=302#302)
