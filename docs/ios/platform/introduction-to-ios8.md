...
![](introduction-to-ios8-images/image1.png "На этой схеме показана базовая иерархия конфигурации аксессуаров HomeKit.")
...
В диалоговом окне **Новый проект** перейдите **C#**  > к**Unified API** > **расширения** **iOS** > , как показано на снимке экрана ниже:
...
Дополнительные сведения об Touch ID и о том, как интегрировать ее в приложение Xamarin. iOS, см. в руководствах по [TouchID](~/ios/platform/touchid.md) .
...
![](introduction-to-ios8-images/image3.png "Схема, представляющая сетку 2 x 2, определяющую различные возможные размеры, которые можно использовать в различных ориентациях.")
 
Дополнительные сведения о классах size см. в статье [Введение в унифицированные](~/ios/user-interface/storyboards/unified-storyboards.md)раскадровки.
...
- [Введение в TouchID](~/ios/platform/touchid.md)
