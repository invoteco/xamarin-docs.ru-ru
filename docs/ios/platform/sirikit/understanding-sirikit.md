...
_Пользователь: Siri Эй отправить сообщение MonkeyChat._<br />
_Siri: Кому?_<br />
...
_Пользователь: Отправьте сообщение Bobo на MonkeyChat._<br />
_Siri: Что вы хотите сказать Bobo?_<br />
_Пользователь: Отправьте дополнительные bananas._<br />
...
_Siri: OUI envoi сообщение s'il vous plaît envoyer плюс de bananes а Bobo sur Monkeychat._<br />

Пока другой пользователь может быть очень подробным в их диалогу:

_Пользователь: Siri Эй, возможность Пожалуйста мне писали и запустите приложение MonkeyChat отправить текстовое сообщение отправьте дополнительные bananas._<br />
_Siri: Кому?_<br />
_Пользователь: Мои рекомендации pal Bobo._<br />
...
_Пользователь: Siri Эй отправить сообщение Bobo на MonkeyChat._<br />
_Siri: Что вы хотите сказать Bobo?_<br />
_Пользователь: Отправьте дополнительные bananas._<br />
...
Siri знает, что несколько является обязательным для отправки сообщений, чем просто получателя, поэтому он проверит быстро с помощью расширения приложения, чтобы увидеть, если сообщение требует содержимое. Так как в случае MonkeyChat Siri отвечает на пользователя с тем вопросом: *«Что вы хотите сказать Bobo?»*
...
## <a name="the-intents-ui-extension"></a>The Intents UI Extension
...
- **Пример приложения использует** -они предоставляют набор часто используется для запросов, которые пользователь мог принять приложения. Пример: *«Запуск тренировок с MonkeyFit».*
