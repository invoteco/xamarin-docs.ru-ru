...
- **Автоматическое обновление** — обеспечивает механизм обновления содержимого приложения iOS в фоновом режиме. При получении автоматического обновления приложение может обратиться к удаленным серверам, чтобы получить последнее содержимое.
