...
Если вы еще не подготовили устройство iOS, прежде чем, следующее руководство поможет выполнить полный пошаговый процесс: [Руководство по подготовки устройства](~/ios/get-started/installation/device-provisioning/index.md)
