...
## <a name="systemexecutionengineexception-attempting-to-jit-compile-method-wrapper-managed-to-managed-foosystemcollectionsgenericicollection1get_count-"></a>System. ExecutionEngineException: попытка выполнить JIT-компиляцию метода foo []: System. Collections. Generic. ICollection'1. get_Count ().
...
Если вы хотите использовать Interface Builder, установите [серию Xcode 3](https://connect.apple.com/cgi-bin/WebObjects/MemberSite.woa/wa/getSoftware?bundleID=20792), доступную на веб-сайте Apple.
