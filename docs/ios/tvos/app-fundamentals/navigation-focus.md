...
- **Создавайте жидкий интерфейс с помощью сенсорного ввода** . Убедитесь, что пользователь может перемещаться между фокусами с минимальными трениями, используя наименьшее число возможных жестов.
...
На Apple TV изображение, кнопка или другой элемент пользовательского интерфейса считаются фокусом, если он является целевым объектом текущей навигации.
...
Как упоминалось выше, элемент пользовательского интерфейса считается фокусом, когда он является текущим элементом во время события навигации. Как правило, элемент находится в фокусе, его размер немного увеличивается и визуально повышается с помощью тени. 
