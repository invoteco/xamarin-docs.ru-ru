...
При настройке свойств представления таблицы в конструкторе iOS, существует два типа содержимого ячейки, которые можно выбрать: **Динамические** или **статический** содержимое прототипа.
...
6.  Изменение корневого контроллера представления быть **содержимого: Динамические прототипы** (представление в области конструктора будет меткой **прототип содержимого** ):
...
-  В **панели свойств**в разделе **элемента кнопки панели** выберите **идентификатор: Добавить** (чтобы сделать его *+* плюс). 
