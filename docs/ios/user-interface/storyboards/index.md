...
> [!IMPORTANT]
> Если вы используете VMWare для виртуальной машины Windows, при нажатии _кнопки мыши по_ умолчанию отображается Нажатие клавиши CTRL. Чтобы создать перехода, измените параметры клавиатуры с помощью **параметров** > **Клавиатура & мышь** > **и** переназначьте вторичную **кнопку** , как показано ниже:
> 
