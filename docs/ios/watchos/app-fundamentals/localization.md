...
2. Создайте каталоги языков  **>.лпрождлякаждогоязыка,которыйвыхотитеподдерживать\<** .
...
1. `Image` Элемент управления можно изменить, присвоив его значению строковое имя изображения, которое уже существует в приложении Watch, например
