...
в watchOS 3 представлено несколько способов упрощения навигации в своих watchOS приложениях, таких как новая вертикальная [разбивка на страницы](#vertical-paging), [Поддержка распознавателя жестов](#gesture-recognizer-support) и [Digital Crown](#digital-crown-rotation) функции ротации, представленные выше.
