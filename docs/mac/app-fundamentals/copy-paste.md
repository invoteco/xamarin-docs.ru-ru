...
@No__t_0 обеспечивает точный контроль над данными, которые записываются на монтажный стол и предназначен для временного доступа. он должен быть удален после того, как он будет записан на монтажный стол.
