...
[![](indepth-images/intro01.png "Раскадровка в Interface Builder Xcode")](indepth-images/intro01.png#lightbox)
...
[![](indepth-images/sb03.png "Настройка начального контроллера")](indepth-images/sb03.png#lightbox)
...
[![](indepth-images/vc01.png "Цепочка ответчиков")](indepth-images/vc01.png#lightbox)
...
[![](indepth-images/vc03.png "Макет контроллера представления")](indepth-images/vc03.png#lightbox)
...
[![](indepth-images/sg02.png "Ввод имени перехода")](indepth-images/sg02.png#lightbox)
...
[![](indepth-images/sg01.png "Установка класса перехода")](indepth-images/sg01.png#lightbox)
...
5. Перетащите **ссылку** раскадровки из **библиотеки объектов** на область конструктора: 
    ...
    [![](indepth-images/ref03.png "Выбор ссылки раскадровки в библиотеке")](indepth-images/ref03.png#lightbox)
...
7. Щелкните мини-приложение пользовательского интерфейса (например, кнопка) в существующей сцене и создайте новый перехода для только что созданной **ссылки** раскадровки.  В контекстном меню выберите команду " **отобразить** ", чтобы завершить перехода: 
    ...
    [![](indepth-images/ref06.png "Установка типа перехода")](indepth-images/ref06.png#lightbox) 
...
2. Добавьте новую сцену и разработайте ее макет, как обычно: 
    ...
    [![](indepth-images/ref07.png "Проектирование макета в Xcode")](indepth-images/ref07.png#lightbox)
...
5. Перетащите **ссылку** раскадровки из **библиотеки объектов** на область конструктора: 
    ...
    [![](indepth-images/ref03.png "Выбор ссылки раскадровки из библиотеки")](indepth-images/ref03.png#lightbox)
