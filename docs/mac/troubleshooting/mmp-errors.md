...
#### <a name="mm1406-target-framework-0-is-invalid-when-targetting-xamarinmac-45-net-framwork"></a>MM1406: Целевая платформа "{0}" недопустима при предназначенных Xamarin. Mac 4,5 .NET фрамворк.
...
#### <a name="mm2009-referenced-by-01------this-message-is-related-to-mm2006-"></a>MM2009: ссылка на {0}.{1} @ no__t_2_\* это сообщение связано с \*ом MM2006\*
