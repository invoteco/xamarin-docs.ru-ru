...
8. Выберите первую метку и в **инспекторе привязки** `self.Person.Name`выберите **Привязка к** > **владельцу файла** и введите **путь к ключу модели** :

    ![Привязка имени](collection-view-images/proto05.png)
9. Выберите вторую метку и в **инспекторе привязки** `self.Person.Occupation`выберите **Привязка к** > **владельцу файла** и введите **путь к ключу модели** :
