...
Существует два основных способа, можно добавить входные данные пользователя нашего пользовательского элемента управления: **Переопределить мыши процедуры обработки** или **распознавателям жестов**. Какой метод, мы используем будет основываться на функциональность, необходимую наш элемент управления.
