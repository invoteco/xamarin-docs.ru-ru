...
## <a name="alertsmacuser-interfacealertmd"></a>[Предупреждения](~/mac/user-interface/alert.md)
...
В этой статье рассматривается создание настраиваемых элементов управления пользовательского интерфейса (путем наследования от `NSControl`), составление пользовательского интерфейса для элемента управления и создание настраиваемых действий, которые можно использовать с Interface Builderом Xcode.
