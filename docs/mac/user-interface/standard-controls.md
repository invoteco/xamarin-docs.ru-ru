...
- **Всплывающее меню** `NSPopUpButton`скруглым текстурированием — A со стилем `NSTexturedRoundedBezelStyle`.
- **Раскрывающееся меню** `NSPopUpButton`скруглым текстурированием — A со стилем `NSTexturedRoundedBezelStyle`.
...
Чтобы прикрепить элемент управления к заданному расположению (x , y), используйте **красный I-Беамс** вокруг поля **ауторесизинг** . Например: 
