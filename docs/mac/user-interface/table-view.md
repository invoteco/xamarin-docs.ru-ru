...
Давайте разрешите пользователю сортировать данные в таблице, щелкнув заголовок столбца. Сначала дважды щелкните `Main.storyboard` файл, чтобы открыть его для редактирования в Interface Builder. `Title` `Ascending`Выберите столбец, введите`compare:` для **ключа сортировки**для селектора и выберите для заказа: `Product`

[![](table-view-images/sort01.png "Задание ключа сортировки")](table-view-images/sort01.png#lightbox)

`Description` `Ascending`Выберите столбец, введите`compare:` для **ключа сортировки**для селектора и выберите для заказа: `Details`
