...
[![](intro-to-ci-images/intro01-small.png "Эта схема иллюстрирует этот процесс")](intro-to-ci-images/intro01.png#lightbox)
...
[![](intro-to-ci-images/intro02-small.png "После отправки этих тестов в центр приложений сервер CI может автоматически запускать их в рамках процесса CI, как показано на этой схеме.")](intro-to-ci-images/intro02.png#lightbox)
...
[![](intro-to-ci-images/intro03-small.png "Эта схема иллюстрирует этот топографии")](intro-to-ci-images/intro03.png#lightbox)
...
[![](intro-to-ci-images/intro04-small.png "Если вы используете Jenkins для создания приложений, вы можете сохранить код в Azure DevOps или Team Foundation Server и продолжить использовать Jenkins для сборок CI.")](intro-to-ci-images/intro04.png#lightbox)
...
[![](intro-to-ci-images/intro05-small.png "Это очень похоже на среду Azure DevOps + Jenkins, о которой говорилось в предыдущем разделе.")](intro-to-ci-images/intro05.png#lightbox)
