...
2. Настройте оболочку или системный путь для включения папки, содержащей файлы, которые были распакованы на предыдущем шаге. Например,
