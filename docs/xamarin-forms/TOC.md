...
#### [Настройка WebView](app-fundamentals/custom-renderer/hybridwebview.md)
...
#### [Относительные привязки](app-fundamentals/data-binding/relative-bindings.md)
...
#### [Жизненный цикл](app-fundamentals/shell/lifecycle.md)
...
#### [Введение](user-interface/carouselview/introduction.md)
#### [Данные](user-interface/carouselview/populate-data.md)
#### [Макет](user-interface/carouselview/layout.md)
#### [Взаимодействие](user-interface/carouselview/interaction.md)
#### [EmptyView](user-interface/carouselview/emptyview.md)
#### [Прокрутка](user-interface/carouselview/scrolling.md)
...
#### [Группирование](user-interface/collectionview/grouping.md)
...
#### [Общие свойства, методы и события](user-interface/controls/common-properties.md)
...
#### [Выбор макета](user-interface/layouts/choose-layout.md)
...
### Карта
#### [Обзор](user-interface/map/index.md)
#### [Инициализация и настройка](user-interface/map/setup.md)
#### [Элемент управления картой](user-interface/map/map.md)
#### [Размещение и расстояние](user-interface/map/position-distance.md)
...
#### [Запуск собственного приложения для работы с картой](user-interface/map/native-map-app.md)
...
### Android
#### [Обзор](platform/android/index.md)
...
#### [Режим перехода прокрутки SwipeView](platform/android/swipeview-swipetransitionmode.md)
...
#### [Контекстные действия ViewCell](platform/android/viewcell-context-actions.md)
...
#### [Режим перехода прокрутки SwipeView](platform/ios/swipeview-swipetransitionmode.md)
...
### Windows
#### [Обзор](platform/windows/index.md)
...
#### [Направление движения RefreshView](platform/windows/refreshview-pulldirection.md)
...
### [Вход с помощью Apple](platform/sign-in-with-apple/index.md)
#### [Настройка для iOS](~/ios/platform/ios13/sign-in.md)
#### [Настройка для других платформ](platform/sign-in-with-apple/setup.md)
#### [Использование входа с помощью Apple](platform/sign-in-with-apple/android-ios-sign-in.md)
...
### [Заметки о выпуске Xamarin.Essentials](https://docs.microsoft.com/xamarin/essentials/release-notes/)
...
### [Ссылка на источник](internals/sourcelink.md)
