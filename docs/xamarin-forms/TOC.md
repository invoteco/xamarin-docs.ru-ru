...
## [Приступая к работе](~/get-started/index.yml)
...
### [Подробный обзор](~/get-started/quickstarts/deepdive.md)
## [XAML](xaml/index.md)
...
### [Рекомендуемые префиксы пространств имен XAML](xaml/custom-prefix.md)
...
### [Индексирование приложения и создание прямых ссылок](app-fundamentals/deep-linking.md)
### [поведения](app-fundamentals/behaviors/index.md)
#### [Вступление](app-fundamentals/behaviors/introduction.md)
#### [Присоединенные реакции на события](app-fundamentals/behaviors/attached.md)
#### [Реакции на события Xamarin.Forms](app-fundamentals/behaviors/creating.md)
#### [Повторно используемые реакции на события](app-fundamentals/behaviors/reusable/index.md)
...
#### [Вступление](app-fundamentals/custom-renderer/introduction.md)
#### [Базовые классы отрисовщика и собственные элементы управления](app-fundamentals/custom-renderer/renderers.md)
#### [Настройка элемента управления Entry](app-fundamentals/custom-renderer/entry.md)
...
##### [Привязка источников видео к проигрывателю](app-fundamentals/custom-renderer/video-player/source-bindings.md)
...
#### [Преобразователи значений привязки](app-fundamentals/data-binding/converters.md)
#### [Резервные значения привязки](app-fundamentals/data-binding/binding-fallbacks.md)
...
#### [Вступление](app-fundamentals/dependency-service/introduction.md)
#### [Реализация преобразования текста в речь](app-fundamentals/dependency-service/text-to-speech.md)
...
#### [Выбор из медиатеки](app-fundamentals/dependency-service/photo-picker.md)
### [Произведенный эффект](app-fundamentals/effects/index.md)
#### [Вступление](app-fundamentals/effects/introduction.md)
...
#### [Касание](app-fundamentals/gestures/tap.md)
#### [Сжатие](app-fundamentals/gestures/pinch.md)
#### [Сдвиг](app-fundamentals/gestures/pan.md)
...
##### [Вступление](app-fundamentals/templates/control-templates/introduction.md)
...
##### [Вступление](app-fundamentals/templates/data-templates/introduction.md)
...
### [Кнопка](user-interface/button.md)
...
#### [Выбранное](user-interface/collectionview/selection.md)
...
#### [Приступая к работе](user-interface/datapages/get-started.md)
#### [Справочник по элементам управления](user-interface/datapages/controls.md)
### [DatePicker](user-interface/datepicker.md)
### [Графика SkiaSharp](user-interface/graphics/skiasharp/index.md)
...
##### [Вступление](user-interface/styles/xaml/introduction.md)
...
#### [Метка](user-interface/text/label.md)
...
#### [Параметры редактора метода ввода записей](platform/android/entry-ime-options.md)
#### [Тени для ImageButton](platform/android/imagebutton-drop-shadow.md)
...
#### [Прокрутка страницы TabbedPage](platform/android/tabbedpage-page-swiping.md)
...
#### [Цвет курсора в поле ввода](platform/ios/entry-cursor-color.md)
#### [Размер шрифта вводимого текста](platform/ios/entry-font-size.md)
...
#### [Тени для VisualElement](platform/ios/visualelement-drop-shadow.md)
#### [Устаревший цветовой режим VisualElement](platform/ios/legacy-color-mode.md)
### [Собственные формы](platform/native-forms.md)
### [Собственные представления](platform/native-views/index.md)
#### [Собственные представления в XAML](platform/native-views/xaml.md)
#### [Собственные представления в C#](platform/native-views/code.md)
...
#### [Проверка орфографии в SearchBar](platform/windows/searchbar-spell-check.md)
...
### [Приступая к работе](~/essentials/get-started.md?context=xamarin/xamarin-forms)
...
### [Адрес эл. почты](~/essentials/email.md?context=xamarin/xamarin-forms)
...
#### [Проверка](data-cloud/serverless/azure-functions.md)
...
### [Автоматическое тестирование в Центре приложений Visual Studio](/appcenter/test-cloud/uitest/get-started-xamarin-forms)
...
### [Вопросы и ответы](troubleshooting/questions/index.md)
...
#### [Почему конструктор XAML в Visual Studio не работает с XAML-файлами Xamarin.Forms?](troubleshooting/questions/forms-xaml-designer.md)
