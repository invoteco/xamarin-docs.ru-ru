...
### [Образы](user-interface/images.md)
...
#### [Data Sources](user-interface/listview/data-and-databinding.md) (Источники данных)
...
### [текст](user-interface/text/index.md)
...
### [Соединение](~/essentials/connectivity.md?context=xamarin/xamarin-forms)
...
### [Share](~/essentials/share.md?context=xamarin/xamarin-forms) (Предоставить общий доступ)
