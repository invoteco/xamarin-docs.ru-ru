...
## <a name="registration-and-resolutionregistration-and-resolutionmd"></a>[Регистрация и разрешение](registration-and-resolution.md)
...
## <a name="picking-a-photo-from-the-libraryphoto-pickermd"></a>[Выбор фотографии в библиотеке](photo-picker.md)
