...
ms.locfileid: "68645924"
---
# <a name="xamarinforms-modal-pages"></a>Модальные страницы Xamarin.Forms

[![Скачать пример](~/media/shared/download.png) Скачать пример](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/navigation-modal)
...
Методы модальной навигации предоставляются свойством [`Navigation`](xref:Xamarin.Forms.NavigableElement.Navigation) любых типов, производных от класса [`Page`](xref:Xamarin.Forms.Page). Эти методы дают возможность [помещать модальные страницы](#Pushing_Pages_to_the_Modal_Stack) в модальный стек и [извлекать модальные страницы](#Popping_Pages_from_the_Modal_Stack) из него.
