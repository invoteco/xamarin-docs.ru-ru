...
(Примечание: Термины с *ограничениями* и *неограниченными* могут быть интуитивно понятными, так как неограниченное представление обычно меньше, чем ограниченное представление. Кроме того эти условия не используются постоянно в первые главы книги.)
...
- Android Светлый текст на темном фоне (в книге) или темном тексте на светлом фоне (для дизайна материалов с помощью AppCompat в **главной** ветви репозитория образца кода)
