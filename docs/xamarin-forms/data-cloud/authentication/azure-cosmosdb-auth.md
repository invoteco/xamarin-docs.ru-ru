...
![](azure-cosmosdb-auth-images/documentdb-authentication.png "Процесс проверки подлинности базы данных документа")
...
1. На портале Azure откройте колонку параметров приложения для веб-приложения и добавьте следующие параметры:
    ...
    [![](azure-cosmosdb-auth-images/azure-web-app-settings.png "Параметры веб-приложения службы приложений")](azure-cosmosdb-auth-images/azure-web-app-settings-large.png#lightbox "параметры веб-приложения службы приложений")
...
1. Настройка имени для входа Facebook следующим образом:
  ...
  ![](azure-cosmosdb-auth-images/facebook-oauth-settings.png "Параметры входа в Facebook OAuth")
...
![](azure-cosmosdb-auth-images/login.png "Имя входа Facebook")
...
Дополнительные сведения о извлечения документов из коллекции документов, см. в разделе [извлечение документа коллекции документов](~/xamarin-forms/data-cloud/azure-services/azure-cosmosdb.md#document_query).
...
Дополнительные сведения о вставке документа в коллекции документов см. в разделе [Вставка документа в коллекции документов](~/xamarin-forms/data-cloud/azure-services/azure-cosmosdb.md#inserting_document).
