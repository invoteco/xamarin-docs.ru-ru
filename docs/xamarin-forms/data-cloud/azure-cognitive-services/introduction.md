...
- Добавление и изменение задач через Экранная клавиатура или выполняет распознавание речи с помощью API распознавания речи Microsoft.
