...
[![Снимки экрана примера базы данных Xamarin. Forms](databases-images/todo-list-sml.png "Снимки экрана первой страницы TodoList") ](databases-images/todo-list.png#lightbox "Снимки экрана первой страницы TodoList") Снимки [ ![экрана примера базы данных Xamarin. Forms](databases-images/todo-list-sml.png "TodoList первая страница") ](databases-images/todo-list.png#lightbox "Снимки экрана первой страницы TodoList")
