...
**Видео Azure Push-уведомлений и Xamarin.Forms**
...
1. Настройка концентратора уведомлений. Дополнительные сведения см. в разделе [Настройка концентратора уведомлений](/azure/app-service-mobile/app-service-mobile-xamarin-forms-get-started-push#configure-hub).
