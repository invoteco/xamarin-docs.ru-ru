...
ms.locfileid: "67659061"
---
# <a name="consume-an-aspnet-web-service-asmx"></a>Использование службы веб-ASP.NET (ASMX)

[![Скачать пример](~/media/shared/download.png) Скачать пример](https://developer.xamarin.com/samples/xamarin-forms/WebServices/TodoASMX/)
