...
ms.locfileid: "75728022"
---
# <a name="using-cocossharp-in-xamarinforms"></a>Использование CocosSharp в Xamarin.Forms

[![Скачать пример](~/media/shared/download.png) Скачать пример](h https://github.com/xamarin/xamarin-forms-samples/tree/master/CocosSharpForms)
