...
На странице « **композиция»** для развертывания на основе кирпича показан пример классической задачи компоновки: Необходимо собрать изображение из нескольких частей, включая точечный рисунок с фоновым рисунком, который необходимо устранить. Вот **SeatedMonkey.jpg** растровое изображение со проблемных фоном:

![Сидели Monkey](porter-duff-images/SeatedMonkey.jpg "сидели Monkey")

В процессе подготовки к композиции, соответствующий _матовой_ был создан, это другой точечного рисунка, который является черной, где требуется для изображения и прозрачно, в противном случае. Этот файл называется **SeatedMonkeyMatte.png** и в том числе ресурсы в **мультимедиа** папку в [ **SkiaSharpFormsDemos** ](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/skiasharpforms-demos) образца :
