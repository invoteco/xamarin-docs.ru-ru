...
Образы можно загружать с [локальный файл](#local-images), [внедренный ресурс](#embedded-images), или [загрузки](#downloading-images). Кроме того, могут отображаться значки шрифта путем [ `Image` ](xref:Xamarin.Forms.Image) представление, указав данные значка шрифта в `FontImageSource` объекта. Дополнительные сведения см. в разделе [отображать значки шрифта](~/xamarin-forms/user-interface/text/fonts.md#display-font-icons) в [шрифты](~/xamarin-forms/user-interface/text/fonts.md) руководства.
...
Кроме того, могут отображаться значки шрифта путем [ `Image` ](xref:Xamarin.Forms.Image) представление, указав данные значка шрифта в `FontImageSource` объекта. Дополнительные сведения см. в разделе [отображать значки шрифта](~/xamarin-forms/user-interface/text/fonts.md#display-font-icons) в [шрифты](~/xamarin-forms/user-interface/text/fonts.md) руководства.
