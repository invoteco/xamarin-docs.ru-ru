...
* **[Сжатие макета](layout-compression.md)** — удаляет указанный макет из визуального дерева при попытке повысить производительность отрисовки страницы.
