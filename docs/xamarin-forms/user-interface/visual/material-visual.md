...
ms.locfileid: "67512898"
---
# <a name="xamarinforms-material-visual"></a>Материал Xamarin.Forms Visual

[![Загрузить образец](~/media/shared/download.png) загрузить пример](https://developer.xamarin.com/samples/xamarin-forms/UserInterface/VisualDemos/)
